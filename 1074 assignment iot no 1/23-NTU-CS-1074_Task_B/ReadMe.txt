...
https://wokwi.com/projects/445799645473426433

2. Pin Map:

| Component            | Pin Number                  | Direction       | Description / Function             |
| -------------------- | --------------------------- | --------------- | ---------------------------------- |
| LED                  | GPIO 19                     | Output          | Turns ON/OFF on short button press |
| Button (Push Button) | GPIO 35                     | Input (Pull-up) | Detects short or long press        |
| Buzzer               | GPIO 17                     | Output          | Emits a tone on long press         |
